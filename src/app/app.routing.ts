...
import {ConversionHomeComponent} from "./modules/struts-conversion/conversion-home/conversion-home.component";
...
export const appRoutes: Route[] = [
    ...
    { path: 'signed-in-redirect', pathMatch: 'full', redirectTo: '/create' },
    {
        ...
        children: [
            ...
            { path: 'pdfexceldashboard', component: InputPageComponent },
